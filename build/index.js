...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`/wp-json/university/v1/search?keyword=${this.searchField.val()}`, results => {
      this.resultsDiv.html(`
    <div class="row">
        <div class="one-third">
        <h2 class="search-overlay__section-title"> Pages <h2>
        <ul class="link-list min-list"> 
      ${results.pages.length === 0 ? "<li>No Results Found</li>" : results.pages.map(result => {
        ...
        <h2 class="search-overlay__section-title"> Professors <h2>
         <ul class="professor-cards"> 
           ${results.professors.length === 0 ? "<li>No Results Found</li>" : results.professors.map(result => {
        return `
        ...
        <ul class="link-list min-list"> 
      ${results.posts.length === 0 ? "<li>No Results Found</li>" : results.posts.map(result => {
        return `<a href="${result.Link}"><li>${result.Name}</li></a>`;
      }).join("")}
      </ul>
        </div>
