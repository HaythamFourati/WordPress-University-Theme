...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`http://university-custom-theme.local/wp-json/wp/v2/posts?search=${this.searchField.val()}`, results => {
      this.resultsDiv.html(`
          <h2 class="search-overlay__section-title">Related Blog Post Articles  </h2> 
          <ul class="link-list min-list"> 
          ${results.length === 0 ? "No Results Found" : results.map(result => {
